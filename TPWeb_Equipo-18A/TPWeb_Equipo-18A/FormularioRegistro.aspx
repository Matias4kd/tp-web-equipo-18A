...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <div id="InformacionPersonal" visible="false">
                    ...
                    <asp:RequiredFieldValidator ID="rfvApellido" ControlToValidate="txtApellido" runat="server"
                        ErrorMessage="El apellido es obligatorio" CssClass="text-danger" Display="Dynamic"></asp:RequiredFieldValidator>
                    <br />
                    ...
                    <asp:RequiredFieldValidator ID="rfvMail" ControlToValidate="txtMail" runat="server"
                    ...
                    <asp:RequiredFieldValidator ID="rfvDireccion" ControlToValidate="txtDireccion" runat="server"
                        ErrorMessage="La dirección es obligatoria" CssClass="text-danger" Display="Dynamic"></asp:RequiredFieldValidator>
                    <br />
                    ...
                    <asp:RequiredFieldValidator ID="rfvCiudad" ControlToValidate="txtCiudad" runat="server"
                        ErrorMessage="La ciudad es obligatoria" CssClass="text-danger" Display="Dynamic"></asp:RequiredFieldValidator>
                    <br />
                    ...
                    <asp:RequiredFieldValidator ID="rfvCP" ControlToValidate="txtCP" runat="server"
                        ErrorMessage="El código postal es obligatorio" CssClass="text-danger" Display="Dynamic"></asp:RequiredFieldValidator>
                    <br />
            ...
            <asp:Button ID="btnParticipar" runat="server" Text="Participar!" OnClick="btnParticipar_Click" CssClass="btn btn-primary" CausesValidation="true" />
